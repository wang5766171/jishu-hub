  ...
  return (
    <div className="text-[0.95em] space-y-2">
      ...
      {Object.keys(input).length > 0 && (
        <pre className="font-mono text-[0.95em] bg-[var(--tool-card-code-bg)] border border-border/45 rounded-lg p-2.5 overflow-x-auto max-h-48 overflow-y-auto whitespace-pre">
