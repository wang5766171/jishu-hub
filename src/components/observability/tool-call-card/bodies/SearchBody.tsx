...
export const SearchBody = memo(function SearchBody({ input, output }: { input: Record<string, unknown>; output?: string }) {
  ...
  return (
    <div className="text-[0.95em] space-y-2">
      ...
      {output && (
        <pre className="font-mono text-[0.95em] bg-[var(--tool-card-code-bg)] border border-border/45 rounded-md p-2.5 overflow-x-auto max-h-48 overflow-y-auto whitespace-pre">
